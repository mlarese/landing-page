...
export const actions = {
    ...
    load ({dispatch, commit, state}, {id = null, force = true, options = {}}) {
        ...
        if (id === null) {
            return dispatch('api/get', {url: `/reservations`, options, debug: false}, root)
                .then(res => {
                    console.dir(res)
            ...
            return dispatch('api/get', {url: `/reservations/{id}`, options}, root)
                .then(res => {
...
export const getters = {
    ...
    customer: state => state.list.reservation,
    booking: s=> s.list.reservation,
    room: s=> s.list.reservation,
